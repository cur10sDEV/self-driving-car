class NeuralNetwork {
  ...
  // this mutate function gives us the ability to mutate
  // the NN in favour of the best brain by adding some amount of randomness
  // amount of randomness is betweeen 0 - 1, 1 being 100% random
